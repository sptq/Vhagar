...
class Admin::LecturesControllerTest < ActionController::TestCase
  ...
  test "should create admin_lecture" do
    assert_difference('Admin::Lecture.count') do
      post :create, admin_lecture: { description: @admin_lecture.description, start_date: @admin_lecture.start_date, title: @admin_lecture.title }
    end
  ...
  test "should update admin_lecture" do
    patch :update, id: @admin_lecture, admin_lecture: { description: @admin_lecture.description, start_date: @admin_lecture.start_date, title: @admin_lecture.title }
    assert_redirected_to admin_lecture_path(assigns(:admin_lecture))
  end
