  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved content as @content" do
        ...
        post :create, {:content => { "title" => "invalid value" }}, valid_session
        assigns(:content).should be_a_new(Content)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested content" do
        ...
        Content.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => content.to_param, :content => { "title" => "MyString" }}, valid_session
      end
